...
export const ThemeTiles: FC = () => {
	...
	const handleTileClicked = (mode: ThemeMode) => async () => {
		if (mode !== preferences.theme) {
			try {
				const payload = { id: preferences.id, theme: mode };
		...
		<Card themeBgColor="bg1">
			...
			<Row justify="space-between" wrap>
				<Column align="center">
					...
					>
						<MaterialIcon fontColor="#fcb63e" fontSize="80px" icon="light_mode" />
					</ThemeCard>
				...
				<Column align="center">
					...
					>
						<MaterialIcon fontColor="#ffffff" fontSize="80px" icon="dark_mode" />
					</ThemeCard>
				...
				<Column align="center">
					...
					>
						<SystemColumn>
							<MaterialIcon fontColor="#fcb63e" fontSize="60px" icon="light_mode" />
						</SystemColumn>
						<SystemColumn dark>
							<MaterialIcon fontColor="#ffffff" fontSize="60px" icon="dark_mode" />
						</SystemColumn>
					</ThemeCard>
